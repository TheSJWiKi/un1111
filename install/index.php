...
<title>Z Counter Installer</title>
...
<nav class="navbar fixed-top navbar-expand-lg navbar-light">
  <div class="container">
    <div class="navbar-brand">
      <h3 class="pb-0">Z Counter Installer</h3>
    </div>
    <!-- /.navbar-brand -->
    <p class="mb-0">
      <i class="far fa-question-circle mr-1"></i>
      If you're having any question, leave a message at <a class="a text-primary" href="mailto:zaiblab@yahoo.com">zaiblab@yahoo.com</a>
    </p>
  </div>
  <!-- /.container -->
</nav>
  ...
  <div class="row">
    ...
    <div class="col-lg-9 content">
        ...
        <div class="table-responsive">
          <table class="table text-nowrap">
            ...
            <tbody>
              <tr>
                <td>PHP v5.6+</td>
                <td>Required Minimum 5.6 PHP Version</td>
              ...
              <tr>
                <td>cURL</td>
                <td>Required for Google reCaptcha</td>
        ...
        <div class="table-responsive">
          ...
          <table class="table text-nowrap">
            ...
            <tbody>
              ...
              <tr>
                <td>/assets/images/uploads</td>
                <td class="text-right"><?php echo permission( 'assets/images/uploads' ); ?></td>
              </tr>
            </tbody>
          </table>
          <hr>
          ...
          <div class="form-row">
            <div class="col-md-6">
              <label for="purchase-code">
                Purchase Code </small> <span class="text-danger">*</span>
                <small><a class="text-primary" href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code-" target="_blank">Need Help in Finding?</a></small>
              </label>
              <input type="text" id="purchase-code" class="form-control" name="purchase_code" required>
            </div>
            <!-- /.form-group -->
          </div>
          <!-- /.form-row -->
      ...
      <?php } else if ( activate_step( 'finishing' ) ) { ?>
        ...
        <hr>
        <a class="btn btn-primary text-white float-right" href="<?php echo ( ! is_mod_rewrite_enabled() ) ? install_url( 'index.php/admin' ) : install_url( 'admin' ); ?>">Finish</a>
      <?php } ?>
    </div>
    <!-- /.col -->
  </div>
